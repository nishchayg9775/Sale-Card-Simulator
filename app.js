...
const BULK_PRESET_LOGO_OPTIONS = APP_CONFIG.bulkPresetLogoOptions || [];
const BULK_PRESET_SHEET_OPTIONS = APP_CONFIG.bulkPresetSheetOptions || [];
if (!BULK_PRESET_LOGO_OPTIONS.length || !BULK_PRESET_SHEET_OPTIONS.length) {
  throw new Error('Missing app-config.js. Load app-config.js before app.js.');
}
...
const BANNER_SIZE = APP_CONFIG.bannerSize;

const BANNER_TEMPLATES = APP_CONFIG.bannerTemplates;
if (!BANNER_SIZE || !BANNER_TEMPLATES || !BANNER_TEMPLATES['nifty-expiry']) {
  throw new Error('Missing app-config.js. Load app-config.js before app.js.');
}
